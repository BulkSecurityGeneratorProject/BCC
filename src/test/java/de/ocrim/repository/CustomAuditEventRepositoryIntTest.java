package de.ocrim.repository;

import de.ocrim.BccApp;
import de.ocrim.config.Constants;
import de.ocrim.config.audit.AuditEventConverter;
import de.ocrim.domain.PersistentAuditEvent;
...
import static de.ocrim.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
